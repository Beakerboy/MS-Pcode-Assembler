...
def test_doc_cache() -> None:
    ...
    cache._modules = [
        ...
        ("SQLDelete", 50, 70, hex2, 0x2c7, 0x87aa, 0x12d9,
         [0x248, 0x308, 0x3b0], 0),
        ("SQLInsert", 50, 54, hex2, 0x2b7, 0x9113, 0x33b,
         [0x248, 0x350, 0x3e0], -1),
        ("SQLQuery", 50, 51, hex2, 0x27b, 0xc472, 0x33b,
         [0x278, 0x3b0, 0x3e0], -1),
        ("SQLQueryGroup", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [0x248], -1),
        ("SQLRecordset", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [0x260], -1),
        ("SQLSelect", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [0x248, 0x308, 0x278, 0x3b0, 0x3e0, 0x350,], -1),
