...
def test_doc_cache() -> None:
    ...
    cache._modules = [
        ...
        ("SQLQuery", 50, 56, hex2, 0x27b, 0x6bdc, 0x2001,
         [0x278, 0x3b0, 0x3e0], -1),
        ("SQLQueryGroup", 50, 75, hex2, 0x2c1, 0xab66, 0x33b, [0x248], -1),
        ("SQLRecordset", 50, 73, hex2, 0x292, 0xfa18, 0x33b, [0x260], -1),
        ("SQLSelect", 50, 60, hex2, 0x2e7, 0x5ac7, 0x33b,
         [0x248, 0x308, 0x278, 0x3b0, 0x3e0, 0x350,], -1),
        ("SQLStaticQuery", 50, 67, hex2, 0x399, 0x652f, 0x33b, [], -1),
        ("SQLSubselect", 48, 108, hex1, 0x39d, 0x9e42, 0x33b, [], -1),
        ("SQLUpdate", 50, 72, hex2, 0x3ab, 0x4cc5, 0x33b, [], -1),
        ("SQLWhereGroup", 50, 59, hex2, 0x2db, 0x3e8c, 0x33b, [], -1),
        ("SQLFactory", 50, 69, hex2, 0x3c8, 0xb67d, 0x33b, [], -1),
        ("SQLHelperFunctions", 50, 76, hex2, 0x3d8, 0xac1b, 0x33b, [], -1),
        ("Login", 48, 113, hex1, 0x403, 0x5c7c, 0x33b, [], -1),
    ]
