...
def test_doc_cache() -> None:
    ...
    cache._modules = [
        ...
        ("SQLRecordset", 50, 73, hex2, 0x292, 0xfa18, 0x338, [0x260], -1),
        ("SQLSelect", 50, 60, hex2, 0x2e7, 0x5ac7, 0x350,
         [0x248, 0x308, 0x278, 0x3b0, 0x3e0, 0x350,], -1),
        ("SQLStaticQuery", 50, 67, hex2, 0x399, 0x652f, 0x368, [0x248, 0x308], -1),
        ("SQLSubselect", 48, 108, hex1, 0x39d, 0x9e42, 0x380, [], -1),
        ("SQLUpdate", 50, 72, hex2, 0x3ab, 0x4cc5, 0x398, [], -1),
        ("SQLWhereGroup", 50, 59, hex2, 0x2db, 0x3e8c, 0x3b0, [], -1),
        ("SQLFactory", 50, 69, hex2, 0x3c8, 0xb67d, 0x3c8, [], -1),
