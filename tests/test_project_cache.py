...
def test_doc_cache() -> None:
    ...
    cache._hex = hex2
    cache._modules = [
        ("ThisWorkbook", 48, 91, hex1, 0x22b, 0xc472, 0, 0x33b),
        ("Sheet1", 48, 93, hex1, 0x22f, 0xd62a, 24, 0x33b),
        ...
        ("SQLDatabase", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
        ("SQLDelete", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
        ("SQLInsert", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
        ("SQLQuery", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
        ("SQLQueryGroup", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
        ("SQLRecordset", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
        ...
        ("Login", 50, 51, hex2, 0x22b, 0xc472, 0, 0x33b),
