...
def test_doc_cache() -> None:
    ...
    cache._data = [0x21e, 0, 7, 14, 18, -1, 5, -1, 4, 2, 8, -1, 11, 16,
                   10, 3, 20, 12, 6, 13, -1, 15, 17, 7, 9, 19]
    hex1 = 0x63c41a11
    hex2 = 0x63c69a74
    ...
    cache._identifiers = [
        ...
        (b'str', 0xAC, 0xD597, 0x0128, 0x00, 20),
        (b'sQuery', 4, 0x96D8),
        ...
        (b'Position', 4, 0xDD1B),
        (b'Keys', 0x00, 0xB871),
        (b'QuickSort', 0xAC, 0xEA8C, 0x128, 0x00, 20),
        ...
        (b'Create_SQLDatabase', 0xAC, 0x4DB8, 0x128, 0x00, 19),
        (b'Create_SQLInsert', 0xAC, 0xC4AC, 0x128, 0x00, 19),
        (b'Create_SQLSelect', 0xAC, 0x1C54, 0x128, 0x00, 19),
        (b'Create_SQLDelete', 0xAC, 0xCA8E, 0x128, 0x00, 19),
        (b'Create_SQLCreate', 0xAC, 0x9F94, 0x128, 0x00, 19),
        (b'Create_SQLUpdate', 0xAC, 0x4E69, 0x128, 0x00, 19),
        (b'Create_SQLStaticQuery', 0xAC, 0x0DD7, 0x128, 0x00, 19),
        (b'SQLHelperFunctions', 12, 0xDD76),
        (b'toUnix', 0xAC, 0xB88A, 0x128, 0x00, 20),
        (b'dt', 4, 0x5CFD),
        (b'DateDiff', 0x00, 0xEAA1),
        (b'toISO', 0xAC, 0xE75E, 0x128, 0x00, 20),
        (b'vArray', 4, 0xAE58),
        (b'WordDelim', 4, 0xA81E),
        (b'LineDelim', 4, 0x253A),
        (b'vbNewLine', 0x00, 0x6175),
        (b'InnerArray', 4, 0x384E),
        (b'getDimension', 0xAC, 0xD7FC, 0x128, 0x00, 20),
        ...
        (b'AssertObjectStringEquals', 0x80, 0xF2A4, 0x00, -253),
        (b'Result', 0x80, 0x7275, 0x00, -253),
        (b'TestReporter', 0x80, 0xDE8F, 0x00, -253),
        (b'_B_var_if', 0x80, 0xF250, 0x00, -253),
        (b'push', 0x00, 0xEA01),
        (b'_B_var_push', 0x80, 0x4F2E, 0x00, -253),
        (b'ArrayPush', 0xAC, 0xA01B, 0x128, 0x00, 20),
        (b'newValue', 4, 0x7FA2), (b'ArrayOush', 0x00, 0xDA7D),
        (b'_B_var_ArrayOush', 0x80, 0xD441, 0x00, -253),
        (b'ArrayPushaJoin', 0x00, 0x3095),
        (b'_B_var_ArrLen', 0x80, 0xDD6F, 0x00, -253),
        (b'IsEmpty', 0x00, 0xF90A)
    ]
    hex = ("02 FF FF 01 01 68 01 00 00 FF FF FF FF FF",
           "FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF",
           "FF FF FF C9 03 13 00 05 00 DB 02 12 00 07 00 FF",
           "FF FF FF FF FF 67 02 06 00 3A 00 FF FF FF FF FF",
           "FF FF FF FF FF FF FF FF FF FF FF FF FF E7 02 0E",
           "00 04 00 D9 03 14 00 11 00 FF FF FF FF FF FF FF",
           "FF FF FF FF FF 77 02 07 00 0B 00 FF FF FF FF FF",
           "FF 7B 02 0B 00 0F 00 FF FF FF FF FF FF FF FF FF",
           "FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF",
           "FF FF FF FF FF 0E 02 01 00 FF FF 10 02 00 00 FF",
           "FF 89 02 08 00 0C 00 FF FF FF FF FF FF FF FF FF",
           "FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF",
           "FF FF FF FF FF 1E 02 FF FF FF FF 20 02 02 00 FF",
           "FF 22 02 03 00 FF FF 24 02 04 00 FF FF 26 02 05",
           "00 FF FF 28 02 06 00 FF FF 2B 02 00 00 19 00 97",
           "02 0D 00 25 00 2F 02 01 00 26 00 31 02 02 00 27",
           "00 99 03 0F 00 28 00 9D 03 10 00 30 00 03 04 15",
           "00 32 00 FF FF FF FF FF FF FF FF FF FF FF FF FF",
           "FF FF FF FF FF B7 02 0A 00 2F 00 3F 02 03 00 29",
           "00 AB 03 11 00 34 00 43 02 04 00 2A 00 FF FF FF",
           "FF FF FF C1 02 0C 00 2F 00 FF FF FF FF FF FF FF",
           "FF FF FF FF FF C7 02 09 00 31 00 FF FF FF FF FF",
           "FF FF FF FF FF FF FF 55 02 05 00 37 00 FF FF FF",
           "FF FF FF 2B 00 3C 00 00 00 01 00 8C 01 00 00 00",
           ...
           "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00",
           "00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00",
           "00 00 00 01 00 00 40 10 00 00 10 00 01 00 00 90",
           "00 00 02 00 00 01 00 00 14 80 08 00 00 00 00 02",
           "00 00 40 00 00 00 10 01 00 00 00 00 00 00 00 00",
           "00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00",
           "00 00")
