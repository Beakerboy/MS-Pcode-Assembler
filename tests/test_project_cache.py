...
def test_doc_cache() -> None:
    ...
    cache._modules = [
        ...
        ("SQLUpdate", 50, 72, hex2, 0x3ab, 0x4cc5, 0x398, [0x248, 0x308], -1),
        ("SQLWhereGroup", 50, 59, hex2, 0x2db, 0x3e8c, 0x3b0, [0x278, 0x30b], -1),
        ("SQLFactory", 50, 69, hex2, 0x3c8, 0xb67d, 0x3c8,
