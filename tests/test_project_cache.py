...
def test_doc_cache() -> None:
    ...
    cache._identifiers = [
        ...
        (b'VBA6', 4, 0x23ad), (b'VBA7', 4, 0x23ae), (b'SQLlib', 0c, 0xc7db),
        (b'sdole', 8, 0x6093), (b'Office', 8, 0x7515),
        (b'MSForms', 8, 0x0f43), (b'ADODB', 8, 0xb273),
        (b'Scripting', 8, 0xdf8A), (b'ThisWorkbook', 0c, 0xe37c),
        (b'_Evaluate', 80, 0xd918), (b'Sheet1', 0c, 0x1ae8),
        (b'iSQLConnection', 0c, 0xc813), (b'Connection', 4, 0xd8da),
        (b'ConnectionString', 4, 0xf2bd), (b'sConnection', 4, 0x8aa5),
        (b'OpenConnection', 4, 0xd05), (b'CloseConnection', 4, 0x74e5),
        (b'State', 4, 0x6f9),
        (b'', 4, 0), (b'', 4, 0), (b'', 4, 0), (b'', 4, 0),
