...
def test_doc_cache() -> None:
    ...
    hex = ("FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF",
           "FF FF FF FF FF FF FF FF C9 03 13 00 05 00 DB 02",
           "12 00 07 00 FF FF FF FF FF FF 67 02 06 00 3A 00",
           "FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF FF",
           "FF FF E7 02 0E 00 04 00 D9 03 14 00 11 00 FF FF",
           "FF FF FF FF FF",
    ...
    hex2 = ("2B 00 3C 00 00 00 01 00 8C 01 00 00 00 00 00 00",
            ...
            "00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00",
            "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00",
            "01 00 00 40 10 00 00 10 00 01 00 00 90 00 00 02",
