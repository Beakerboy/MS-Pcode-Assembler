...
def test_doc_cache() -> None:
    ...
    cache._modules = [
        ...
        ("SQLCreate", 50, 71, hex2, 0x277, 0x9bce, 0x7b6, [0x0248, 0x0308], -1),
        ...
        ("SQLDelete", 50, 70, hex2, 0x2c7, 0x87aa, 0x12d9,
         [0x248, 0x308, 0x3b0], 0),
        ("SQLInsert", 50, 54, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLQuery", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLQueryGroup", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLRecordset", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLSelect", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLStaticQuery", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLSubselect", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLUpdate", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLWhere", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLFactory", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLHelperFunctions", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("Login", 50, 51, hex2, 0x22b, 0xc472, 0x33b, [], -1),
    ]
