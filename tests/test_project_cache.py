...
def test_doc_cache() -> None:
    ...
    cache._identifiers = [
        ...
        (b'Hide', 0x00, 0x7A39),
        (b'Workbook', 4, 0x186B),
        (b'iTestableProject', 0x80, 0x3408, 0x00, 0xff03),
        (b'TestRunner', 0x80, 0xF9E0, 0x00, 0xff03),
        (b'CreateTestRunner', 0x80, 0x0707, 0x00, 0xff03),
        (b'iTestCase', 0x80, 0xE037, 0x00, 0xff03),
        (b'Class', 4, 0xBB1A),
        (b'Initialize', 0x80, 0x4ED3, 0x00, 0x103),
        (b'CreateTestCase', 0x80, 0xD159, 0x00, 0xff03),
        (b'Actual', 0x80, 0x9101, 0x00, 0xff03),
        (b'Expected', 0x80, 0xA87F, 0x00, 0xff03),
        (b'AssertEquals', 0x80, 0x45C1, 0x00, 0xff03),
        (b'_B_var_iLength', 0x80, 0xE3C2, 0x00, 0xff03),
