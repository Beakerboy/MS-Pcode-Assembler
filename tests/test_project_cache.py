...
def test_doc_cache() -> None:
    ...
    cache._modules = [
        ...
        ("SQLInsert", 50, 54, hex2, 0x2b7, 0x9113, 0x1e8d,
         [0x248, 0x350, 0x3e0], -1),
        ("SQLQuery", 50, 56, hex2, 0x27b, 0x6bdc, 0x201,
         [0x278, 0x3b0, 0x3e0], -1),
        ("SQLQueryGroup", 50, 75, hex2, 0x22b, 0xc472, 0x33b, [0x248], -1),
        ("SQLRecordset", 50, 73, hex2, 0x22b, 0xc472, 0x33b, [0x260], -1),
        ("SQLSelect", 50, 60, hex2, 0x22b, 0xc472, 0x33b,
         [0x248, 0x308, 0x278, 0x3b0, 0x3e0, 0x350,], -1),
        ("SQLStaticQuery", 50, 67, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLSubselect", 48, 108, hex1, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLUpdate", 50, 72, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLWhereGroup", 50, 59, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLFactory", 50, 69, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("SQLHelperFunctions", 50, 76, hex2, 0x22b, 0xc472, 0x33b, [], -1),
        ("Login", 48, 113, hex1, 0x22b, 0xc472, 0x33b, [], -1),
    ]
